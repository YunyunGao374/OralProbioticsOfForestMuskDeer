...
# =========================
# 2. 过滤：total > 100 + Control 组
# =========================
df_filt <- df %>%
  filter(total > 100, Groups == "Control")
...
# （可选）保存图片
# =========================
ggsave("Control_percent_stacked.pdf", p_pct, width = 8, height = 5, dpi = 300)
ggsave("Control_count_stacked.pdf",   p_cnt, width = 8, height = 5, dpi = 300)
